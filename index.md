...
## 2.- Requisitos
  ...
  * -(OPCIONAL) 2x Webcams. Puede evitarse utilizar el "Pendrive 3" para firmar la transacción si se utilizan 2 PCs, cada uno con una webcam, y se transfiere mediante QR.      
